...
import { works, workById } from "./content/works.js";
...
export default function ProjectDetail({ projectId }) {
  ...
  useEffect(() => {
    if (work) {
      document.title = `${work.title} | DE.LA.COSTA`;
      track("Work project viewed", { project: work.id });
    }
  }, [work]);

  if (!work) {
    return (
      <SiteShell mainId="project-main">
        <main id="project-main" className="project-missing">
          <h1>That project is not in the archive yet.</h1>
          <a href="/work">Return to the work</a>
        </main>
      </SiteShell>
    );
  }
    ...
    <SiteShell mainId="project-main">
      <main id="project-main">
        <section className="project-hero">
          <img src={work.image} alt={work.title} fetchPriority="high" decoding="async" loading="eager" style={{ aspectRatio: "16/10", width: "100%", height: "auto" }} />
          <div>
        ...
        <section className="project-inquiry">
          <div>
            <span>Collect / collaborate</span>
            <h2>Ask the studio about this work.</h2>
          </div>
          <p>Availability, print editions, exhibition loans, licensing, and project-specific collaboration are confirmed directly by the studio.</p>
          <a href={mailto}>Start an inquiry</a>
        </section>
