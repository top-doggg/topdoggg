    ...
    <div className="artist-home" id="top">
      ...
      <main id="main">
        ...
        <section className="inquiry-section" id="inquire">
          <div><span>Work with DE.LA.COSTA</span><h2>Bring me the project, not just the brief.</h2><p className="inquiry-lede">Available for selected commissions, collaborations, and creative projects where art, story, place, and visual identity need to work together.</p></div>
          <div className="inquiry-details"><p>Photography, visual campaigns, creative direction, film and video, design, murals and public art, artist collaborations, and community or cultural projects. Include the project, timeline, location, and what you are trying to create.</p><div className="inquiry-types"><span>Photography</span><span>Creative direction</span><span>Film / video</span><span>Design</span><span>Murals / public art</span><span>Collaborations</span></div><div className="inquiry-actions"><a href="mailto:trststudiogallery@gmail.com?subject=Project%20Inquiry%20for%20DE.LA.COSTA" onClick={() => trackHome("Project inquiry email click")}>Start an inquiry →</a><a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackHome("Project inquiry Instagram click")}>Instagram →</a></div></div>
        </section>
      ...
      <footer className="artist-footer"><div><strong>DE.LA.COSTA</strong><small>Jorge S. Ruiz / TRST Studios</small></div><div className="footer-links"><a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer">Instagram</a><a href="/shop#shop">Shop</a><a href="#inquire">Project inquiries</a><a href="/fulfillment-policy">Customer care</a><a href="mailto:trststudiogallery@gmail.com">Collector inquiries</a></div><small>Southern California / independent visual practice.</small></footer>
    </div>
  );
}
